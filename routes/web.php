...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('matchmaker-applications/{matchmakerApplication}/set-password', [\App\Http\Controllers\Admin\MatchmakerApplicationController::class, 'setPassword'])->name('matchmaker-applications.set-password')->middleware('can:matchmaker-applications.manage');
    Route::post('matchmaker-applications/{matchmakerApplication}/withdraw', [\App\Http\Controllers\Admin\MatchmakerApplicationController::class, 'withdraw'])->name('matchmaker-applications.withdraw')->middleware('can:matchmaker-applications.manage');
    Route::post('matchmaker-applications/{matchmakerApplication}/reactivate', [\App\Http\Controllers\Admin\MatchmakerApplicationController::class, 'reactivate'])->name('matchmaker-applications.reactivate')->middleware('can:matchmaker-applications.manage');
    Route::delete('matchmaker-applications/{matchmakerApplication}', [\App\Http\Controllers\Admin\MatchmakerApplicationController::class, 'destroy'])->name('matchmaker-applications.destroy')->middleware('can:matchmaker-applications.manage');
    Route::post('matchmaker-applications/{matchmakerApplication}/card-dispatched', [\App\Http\Controllers\Admin\MatchmakerApplicationController::class, 'markCardDispatched'])->name('matchmaker-applications.card-dispatched')->middleware('can:matchmaker-applications.manage');
...
Route::middleware(['auth', 'matchmaker'])->prefix('matchmaker')->name('matchmaker.')->group(function () {
    ...
    Route::post('/nikah-interests/{interest}/accept', [\App\Http\Controllers\Matchmaker\NikahBrowseController::class, 'acceptInterestOnBehalf'])->name('nikah.interests.accept');
    Route::post('/nikah-interests/{interest}/decline', [\App\Http\Controllers\Matchmaker\NikahBrowseController::class, 'declineInterestOnBehalf'])->name('nikah.interests.decline');
    ...
    Route::post('/clients/{lead}/set-password', [\App\Http\Controllers\Matchmaker\ClientController::class, 'setLoginPassword'])->name('clients.set-password');
