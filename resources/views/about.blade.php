 ...
 <head>
     <meta charset="utf-8">
     <title>About | Sallaamti Importance of Quran Education and Empowering Humanity</title>
             ...
             <div class="row g-5">
                 <div class="col-lg-4 col-xl-5">
                     <div class="team-img wow zoomIn" data-wow-delay="0.1s">
                         <img src="{{ asset('img/team-1.jpg') }}" class="img-fluid" alt="Anamul Hasan">
                     </div>
                 </div>
                     ...
                     <div class="row g-4">
                         <div class="col-md-4">
                             <div class="team-item wow zoomIn" data-wow-delay="0.2s">
                                 <img src="{{ asset('img/team-2.jpg') }}" class="img-fluid w-100" alt="Mustafa Kamal">
                         ...
                         <div class="col-md-4">
                             <div class="team-item wow zoomIn" data-wow-delay="0.6s">
                                 <img src="{{ asset('img/team-4.jpg') }}" class="img-fluid w-100" alt="Asfaque Ali">
                                 <div class="team-content text-dark text-center py-3">
                                     <div class="team-content-inner">
         ...
         <div class="container py-4">
             ...
             <div class="row">
                 ...
                 <div class="col-md-6 text-center text-md-end">
                     ...
                     Designed & Developed By <a class="border-bottom" href="https://htmlcodex.com">HTML Codex</a>
                 </div>
             </div>
         </div>
     </div>
