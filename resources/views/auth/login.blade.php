<x-auth-layout>
    <div class="auth-wrapper">
        <div class="auth-card" style="max-width: 560px" x-data="{ tab: 'login' }">
            ...
            <div class="flex items-center gap-2 justify-center text-sm font-medium rounded-lg py-2.5 px-4 mb-6" style="background: var(--teal-light); color: var(--teal)">
                ...
                {{ __('db.Great choice! Sign in (or create an account) to start with :module.', ['module' => $moduleLabels[$moduleParam][1]]) }}
            </div>
            @endif
            ...
            <div x-show="tab === 'login'">
                <div class="text-center mb-5">
                    ...
                    <p class="text-gray-500 text-xs mt-1">{{ __('db.Sign in to your Sallaamti account') }}</p>
                </div>
