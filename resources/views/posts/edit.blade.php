<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">✏️ Edit Post</h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <p class="text-sm text-amber-600 bg-amber-50 border border-amber-200 rounded-lg p-3 mb-6">
                    ⚠️ This post is already live. Saving changes will send it back for admin review before the edits go public.
                </p>
                @endif
                ...
                <p class="text-sm text-red-600 bg-red-50 border border-red-200 rounded-lg p-3 mb-6">
                    This post wasn't approved: {{ $post->rejection_reason }}. Update it below and resubmit.
                </p>
                @endif
                ...
                <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="flex justify-between pt-2">
                        <a href="{{ route('posts.mine') }}" class="btn-base text-gray-600 border border-gray-300 px-4 py-2 rounded-md hover:bg-gray-50">← Back</a>
