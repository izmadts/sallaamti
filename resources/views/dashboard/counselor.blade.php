        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="divide-y">
                    ...
                    <a href="{{ route('counselor.bookings.index') }}" class="py-3 flex justify-between items-center hover:bg-gray-50 -mx-2 px-2 rounded">
                        <div>
                            <p class="text-sm font-medium text-gray-800">{{ $booking->scheduled_at->format('d M Y, h:i A') }}</p>
                            <p class="text-xs text-gray-500">{{ $booking->member->name }}</p>
                        </div>
