<x-guest-layout>
    <div class="card" style="width: 30rem; margin: auto; margin-top: 200px; padding: 30px;">
        ...
        <form method="POST" action="{{ route('donate.store') }}" enctype="multipart/form-data">
            ...
            <div><label class="mb-1 mt-2"> Transaction Reference ID:</label><input name="payment_reference" class="form-control mb-3" required /></div>
