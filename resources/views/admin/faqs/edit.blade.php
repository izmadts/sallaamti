    ...
    <div class="max-w-2xl bg-white rounded-lg shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('admin.faqs.update', $faq) }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea name="answer_en" rows="4" class="w-full mt-1 border-gray-300 rounded-lg focus:border-teal-500 focus:ring-teal-500" required>{{ old('answer_en', $faq->answer_en) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="answer_ur" rows="4" dir="rtl" class="w-full mt-1 border-gray-300 rounded-lg focus:border-teal-500 focus:ring-teal-500">{{ old('answer_ur', $faq->answer_ur) }}</textarea>
