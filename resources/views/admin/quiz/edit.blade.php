    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form method="POST" action="{{ route('admin.courses.quiz.store', $course) }}" class="space-y-4">
                    @csrf
                    <div>
                        <x-input-label value="Quiz Title" />
                        <x-text-input name="title" class="w-full mt-1" :value="$quiz->title ?? 'Course Quiz'" required />
                    </div>
                    <div>
            ...
            <div>
                <x-input-label value="Correct Option (0 = first, 1 = second, etc.)" />
