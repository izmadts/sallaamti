...
<ul>
    ...
    <li><strong>You don't see a client's phone number either — not even your own client's.</strong> Their number shows masked (e.g. <code>03••••••••43</code>) everywhere on your own screens. This isn't a bug — it's the same principle as CNIC/photo redaction. You still get everything you actually need: a <strong>Copy Link</strong> button for their one secure link, ready to paste into WhatsApp, Messenger, SMS, or wherever you're already talking to them.</li>
    <li><strong>You never see the client's link either — only a Copy Link button.</strong> Press it, then paste directly into whatever app you're messaging them on. Nothing about the link itself is ever shown as text on your screen.</li>
    <li><strong>Every visit to a client's link is logged.</strong> The system quietly records the time, approximate location, and device — not to spy on them, but so there's a real record if something ever needs to be checked.</li>
...
<p>The sidebar covers everything: <strong>Dashboard</strong>, <strong>My Clients</strong>, <strong>Add Client</strong>, <strong>Browse Profiles</strong>, and <strong>My Contact Requests</strong>. Your avatar in the top-right corner carries a colored ring and a small badge showing your current level (🥉 Nikah Counselor → 🥈 Certified → 🥇 Senior → ⭐ Regional Coordinator) — tap it any time to open <strong>My Performance</strong>.</p>

<h3>Step 1 — Add a Client</h3>
<p>Most real leads arrive over WhatsApp or a Facebook/Instagram ad and never register themselves. Press <strong>Add Client</strong> and record their name, phone/email, gender, and source — they're assigned to you automatically. The moment you save a phone number, their one secure link is generated automatically — no separate step. Update their <strong>Status</strong> as things move (New → Contacted → Interested → Registered, or Not Interested/Closed), and set a <strong>Next Follow-up</strong> date so it surfaces on your dashboard.</p>
...
<p>There's no separate link to copy per candidate any more — the moment a batch is sent, those candidates simply appear on the client's <strong>one</strong> secure link, where they review each one (photo placeholder, age/city/education/profession/about, and why you suggested it) and respond Interested / Maybe / Not Interested directly. You'll see their response reflected right back in this tab.</p>
<p>If the client's package has a proposal limit, this tab shows how many they have left and when the package expires. Sending is blocked once their limit is used up or the package has expired.</p>

<h3>Sending the Client Their Link</h3>
<p>Every client gets exactly <strong>one</strong> link, generated automatically the moment you save a phone number for them. On their Overview tab, press <strong>📋 Copy Link</strong> and paste it into WhatsApp, Messenger, SMS, or however you're already talking to them — the link text itself is never shown on your screen, by design (see the security note above). That same link is where they'll confirm consent, choose and pay for a package, review proposed matches, upload documents if needed, and check their status — every time, nothing separate to send for each of those.</p>
<p>If anything ever feels off — wrong number, suspected leak, client lost it and asks for a fresh one — press <strong>↻ Regenerate</strong>. The old copy stops working immediately, wherever it ended up.</p>

<h3>Step 7 — Registering a New Client</h3>
<p>If someone's ready to actually register, open their client page and press <strong>Convert to Registered Profile</strong> — this takes you into the walk-in wizard, with their name and phone/email already filled in. If a profile already exists separately, use the "Already have a profile for them?" box and enter the profile ID instead.</p>
<p>Standing in front of someone who hasn't been added as a client yet? Use <strong>Register Walk-in Client</strong> in the sidebar to start the same wizard directly, without a client record first — useful for a walk-in you're registering on the spot. You can still add them as a client afterward and link the finished profile.</p>

<h3>Registering Someone You Can't Meet In Person</h3>
<p><strong>Never collect a lead's CNIC over WhatsApp — not the number, not a photo of it, not their picture.</strong> If you're registering someone remotely, check <strong>"I don't have their CNIC/photo yet — send them a secure link to upload it themselves"</strong> on the Verification step. Their profile is created without those documents, and their secure link — the same one link they use for everything else — will show a document-upload step the next time they visit it.</p>
<p>This only works if they have a phone/WhatsApp number on file. If you only have their email, add a phone number to their account before this can be generated.</p>

<h3>Collecting Their Verification Fee Payment</h3>
...
<p>They'll also see an optional, skippable offer to set up a 4-digit PIN — this turns their link into a real account they can log into directly at sallaamti.com later, not just through this one link. If they say "not now," it never asks again.</p>
...
<ul>
    ...
    <li>Anything feels off (leaked link, suspicious activity)? <strong>Regenerate</strong> and, if needed, tell an admin.</li>
</ul>
...
<ul>
    ...
    <li><strong>آپ کو کلائنٹ کا موبائل نمبر بھی نہیں دکھایا جاتا — اپنے ہی کلائنٹ کا بھی نہیں۔</strong> ان کا نمبر آپ کی اپنی سکرین پر ہر جگہ چھپا ہوا نظر آتا ہے (مثلاً <code>03••••••••43</code>)۔ یہ کوئی خرابی نہیں — یہ بالکل وہی اصول ہے جو شناختی کارڈ/تصویر پر لاگو ہوتا ہے۔ آپ کو وہی سب کچھ ملتا ہے جس کی آپ کو حقیقتاً ضرورت ہے: ان کے محفوظ لنک کے لیے ایک <strong>لنک کاپی کریں</strong> بٹن، جسے واٹس ایپ، میسنجر، ایس ایم ایس، یا جہاں بھی آپ ان سے پہلے سے بات کر رہے ہوں وہاں پیسٹ کرنے کے لیے تیار ہے۔</li>
    <li><strong>کلائنٹ کا لنک بھی آپ کو نظر نہیں آتا — صرف ایک کاپی لنک بٹن۔</strong> بٹن دبائیں، پھر سیدھا اسی ایپ میں پیسٹ کریں جہاں آپ ان سے بات کر رہے ہیں۔ لنک خود کبھی بھی متن کے طور پر آپ کی سکرین پر نہیں دکھایا جاتا۔</li>
    <li><strong>کلائنٹ کے لنک کی ہر وزٹ ریکارڈ ہوتی ہے۔</strong> نظام خاموشی سے وقت، تخمینی مقام، اور آلہ ریکارڈ کرتا ہے — جاسوسی کے لیے نہیں، بلکہ اس لیے کہ اگر کبھی کچھ چیک کرنے کی ضرورت پڑے تو ایک حقیقی ریکارڈ موجود ہو۔</li>
...
<p>سائیڈبار میں سب کچھ موجود ہے: <strong>ڈیش بورڈ</strong>، <strong>میرے کلائنٹس</strong>، <strong>کلائنٹ شامل کریں</strong>، <strong>پروفائلز براؤز کریں</strong>، اور <strong>میری رابطہ درخواستیں</strong>۔ اوپر دائیں کونے میں آپ کی تصویر پر ایک رنگین دائرہ اور آپ کی موجودہ سطح کا چھوٹا نشان ہوتا ہے (🥉 نکاح کاؤنسلر → 🥈 سرٹیفائیڈ → 🥇 سینیئر → ⭐ ریجنل کوآرڈینیٹر) — کسی بھی وقت <strong>میری کارکردگی</strong> کھولنے کے لیے اسے دبائیں۔</p>

<h3>مرحلہ 1 — کلائنٹ شامل کریں</h3>
<p>زیادہ تر حقیقی لیڈز واٹس ایپ یا فیس بک/انسٹاگرام اشتہار سے آتی ہیں اور کبھی خود رجسٹر نہیں ہوتیں۔ <strong>کلائنٹ شامل کریں</strong> دبائیں اور ان کا نام، فون/ای میل، جنس، اور ذریعہ درج کریں — وہ خودکار طور پر آپ کو تفویض ہو جاتے ہیں۔ جیسے ہی آپ فون نمبر محفوظ کریں، ان کا محفوظ لنک خودکار طور پر بن جاتا ہے — کوئی الگ مرحلہ نہیں۔ جیسے جیسے معاملہ آگے بڑھے <strong>حیثیت</strong> اپ ڈیٹ کریں (نئی → رابطہ ہوا → دلچسپی → رجسٹرڈ، یا دلچسپی نہیں/بند)، اور ایک <strong>اگلا فالو اپ</strong> تاریخ مقرر کریں تاکہ یہ آپ کے ڈیش بورڈ پر نظر آئے۔</p>
...
<p>اب ہر امیدوار کے لیے الگ لنک نہیں ہے — بیچ بھیجتے ہی وہ امیدوار سیدھا کلائنٹ کے <strong>ایک</strong> محفوظ لنک پر نظر آ جاتے ہیں، جہاں وہ ہر ایک کا جائزہ لے کر (تصویر، عمر/شہر/تعلیم/پیشہ/تعارف، اور آپ نے یہ کیوں تجویز کیا) براہ راست دلچسپی ہے / شاید / دلچسپی نہیں میں جواب دیتے ہیں۔ ان کا جواب اسی ٹیب میں فوراً نظر آ جائے گا۔</p>
<p>اگر کلائنٹ کے پیکج میں تجویز کی حد مقرر ہے، تو یہ ٹیب دکھاتا ہے کہ ان کے پاس کتنی باقی ہیں اور پیکج کب ختم ہوگا۔ حد ختم ہونے یا پیکج کی میعاد گزرنے پر بھیجنا روک دیا جاتا ہے۔</p>

<h3>کلائنٹ کو ان کا لنک بھیجنا</h3>
<p>ہر کلائنٹ کو بالکل <strong>ایک</strong> لنک ملتا ہے، جو فون نمبر محفوظ کرتے ہی خودکار طور پر بن جاتا ہے۔ ان کے خلاصہ ٹیب پر، <strong>📋 لنک کاپی کریں</strong> دبائیں اور اسے واٹس ایپ، میسنجر، ایس ایم ایس، یا جہاں بھی آپ پہلے سے ان سے بات کر رہے ہوں وہاں پیسٹ کر دیں — لنک کا متن خود کبھی بھی آپ کی سکرین پر نہیں دکھایا جاتا، جان بوجھ کر (اوپر سیکیورٹی نوٹ دیکھیں)۔ یہی لنک ہے جہاں وہ رضامندی دیں گے، پیکج منتخب کر کے ادائیگی کریں گے، تجویز کردہ رشتوں کا جائزہ لیں گے، ضرورت پڑنے پر دستاویزات اپلوڈ کریں گے، اور اپنی حیثیت چیک کریں گے — ہر بار، ہر کام کے لیے الگ کچھ بھیجنے کی ضرورت نہیں۔</p>
<p>اگر کبھی کچھ غلط محسوس ہو — غلط نمبر، لیک ہونے کا شبہ، کلائنٹ نے لنک کھو دیا اور نیا مانگا — <strong>↻ دوبارہ بنائیں</strong> دبائیں۔ پرانی کاپی فوراً کام کرنا بند کر دیتی ہے، چاہے وہ کہیں بھی پہنچ چکی ہو۔</p>

<h3>مرحلہ 7 — نئے کلائنٹ کی رجسٹریشن</h3>
<p>اگر کوئی واقعی رجسٹر ہونے کے لیے تیار ہو، تو ان کا کلائنٹ صفحہ کھولیں اور <strong>رجسٹرڈ پروفائل میں تبدیل کریں</strong> دبائیں — یہ آپ کو واک اِن عمل میں لے جاتا ہے، جس میں ان کا نام اور فون/ای میل پہلے سے بھرا ہوتا ہے۔ اگر پروفائل پہلے سے علیحدہ طور پر موجود ہے، تو "کیا ان کے لیے پہلے سے پروفائل موجود ہے؟" باکس استعمال کریں اور پروفائل آئی ڈی درج کریں۔</p>
<p>کیا آپ کے سامنے کوئی ایسا شخص کھڑا ہے جسے ابھی تک کلائنٹ کے طور پر شامل نہیں کیا گیا؟ سائیڈبار میں <strong>واک اِن کلائنٹ رجسٹر کریں</strong> استعمال کر کے پہلے کلائنٹ ریکارڈ کے بغیر براہ راست وہی عمل شروع کریں — کسی ایسے واک اِن کے لیے مفید جسے آپ فوری طور پر رجسٹر کر رہے ہوں۔ بعد میں انہیں کلائنٹ کے طور پر شامل کر کے مکمل شدہ پروفائل جوڑ سکتے ہیں۔</p>

<h3>اگر آپ کسی بندے سے خود مل نہ سکیں</h3>
<p><strong>کسی کا شناختی کارڈ (CNIC) کبھی بھی واٹس ایپ پر نہ منگوائیں</strong> — نہ نمبر، نہ کارڈ کی تصویر، نہ اُس کی اپنی تصویر۔ اگر کوئی بندہ دور بیٹھا ہے اور آپ اُس سے مل نہیں سکتے، تو ویریفیکیشن والے مرحلے میں یہ باکس ٹک کر دیں:</p>
<p style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:8px;padding:10px 14px;">"میرے پاس ابھی اِن کا شناختی کارڈ/تصویر نہیں ہے — ایک محفوظ لنک بھیج دیں تاکہ وہ خود اپلوڈ کر سکیں۔"</p>
<p>یہ ٹک کرنے سے پروفائل بن جائے گی، شناختی کارڈ کے بغیر بھی۔ ان کا محفوظ لنک — وہی ایک لنک جو وہ ہر کام کے لیے استعمال کرتے ہیں — اگلی بار وزٹ کرنے پر دستاویزات اپلوڈ کرنے کا مرحلہ دکھائے گا۔</p>
<p>یاد رکھیں: یہ تب ہی کام کرے گا جب اُس کا فون/واٹس ایپ نمبر آپ نے درج کیا ہو۔ اگر صرف ای میل ہے، پہلے فون نمبر شامل کریں۔</p>

<h3>ان کی تصدیقی فیس کی ادائیگی وصول کرنا</h3>
...
<p>انہیں ایک اختیاری، چھوڑی جا سکنے والی پیشکش بھی نظر آئے گی — ایک 4 ہندسوں کا PIN بنانے کی — جو ان کے لنک کو ایک حقیقی اکاؤنٹ میں بدل دیتا ہے جسے وہ بعد میں براہ راست sallaamti.com پر لاگ اِن کر سکیں، نہ صرف اسی ایک لنک سے۔ اگر وہ "ابھی نہیں" کہیں تو یہ دوبارہ کبھی نہیں پوچھے گا۔</p>
...
<ul>
    ...
    <li>کچھ غلط محسوس ہو (لنک لیک، مشکوک سرگرمی)؟ <strong>دوبارہ بنائیں</strong> اور ضرورت پڑے تو ایڈمن کو بتائیں۔</li>
</ul>
