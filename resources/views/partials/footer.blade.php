        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-8">
            ...
            <div>
                ...
                <div class="flex flex-col items-start">
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ route('index') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Home</a>
                    ...
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ route('blog.index') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Blog</a>
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ url('/events') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Events</a>
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ url('/sermons') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Sermons</a>
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ url('/testimonial') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Testimonials</a>
                    <a class="text-gray-300 hover:text-white mb-2" href="{{ url('/team') }}"><i class="fa fa-check text-[--teal] mr-2"></i>Our Team</a>
