<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form method="POST" action="{{ route('lesson.quiz.submit', $lesson) }}" class="bg-white rounded-lg shadow-sm p-6 space-y-6">
                @csrf
            ...
            <a href="{{ route('lessons.show', $lesson) }}" class="text-sm text-gray-500 hover:underline">← Back to lesson</a>
